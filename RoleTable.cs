...
namespace Glocal.Identity.MySQL
{
    ...
    public class RoleTable 
    {
        ...
        {
            string commandText = "Insert into Role (Id, Name) values (@id, @name)";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
            string commandText = "Select Name from Role where Id = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@id", roleId);
        ...
        {
            string roleId = null;
            string commandText = "Select Id from Role where Name = @name";
        ...
        {
            string commandText = "Update Role set Name = @name where Id = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@id", role.Id);
