...
namespace Glocal.Identity.MySQL
{
        ...
        where TUser :ShodhUser
    {
        ...
        {
            string commandText = "Select PasswordHash from User where Id = @id";
        ...
        {
            string commandText = "Update User set PasswordHash = @pwdHash where Id = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
            string commandText = "Select SecurityStamp from User where Id = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@id", userId } };
        ...
        {
            string commandText = @"Insert into User (UserName, Id, PasswordHash, SecurityStamp,Email,EmailConfirmed,PhoneNumber,PhoneNumberConfirmed, AccessFailedCount,LockoutEnabled,LockoutEndDateUtc,TwoFactorEnabled)
        ...
        {
            string commandText = @"Update User set UserName = @userName, PasswordHash = @pswHash, SecurityStamp = @secStamp, 
